function socio() {
    ...
    if (nuevoSocioEdad >= 18) {
        ...
        if (tribuna === "A") {
            ...
            if (confirmarA === "SI") {
                let tarjeta = prompt("Gracias " + nuevoSocioNombre + ". Dentro de las 72hs nos vamos a estar comunicando con vos, ¿cómo te gustaría hacer el pago? Credito o Debito?").toLowerCase();
                if (tarjeta === "debito") {
            ...
            if (confirmarB === "SI") {
                let tarjeta = prompt("Gracias " + nuevoSocioNombre + ". Dentro de las 72hs nos vamos a estar comunicando con vos, ¿cómo te gustaría hacer el pago? Credito o Debito?");
                if (tarjeta === "debito") {
                    alert("Podes hacerlo hasta en 6 cuotas SIN INTERES! Nos vamos a estar comunicando con vos!");
                } else {
                    alert("gracias por visitar la pagina del club atletico Belgrano. A la brevedad nos pondremos en contacto con vos!");
